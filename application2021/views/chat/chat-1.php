                        ...
                        <div class="hide-scrollbar h-100" id="chatContactsList">
                            ...
                            <div class="sidebar-header sticky-top p-2">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <h5 class="font-weight-semibold mb-0"><a href="<?php echo base_url(); ?>">Home</a></h5>
                                            ...
                                            <div class="message-options">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a class="dropdown-item d-flex align-items-center text-danger" href="javascript:void(0)" onclick="delete_message('<?php echo $message_id ?>')">
