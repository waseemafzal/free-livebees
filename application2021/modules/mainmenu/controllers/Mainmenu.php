...

{
...

	{
		...
		$this->form_validation->set_rules('slug', 'Clean Url', 'trim|required');

		$this->form_validation->set_rules('controller', 'Actual Url', 'trim|required');

		$this->form_validation->set_rules('title_french', 'Nav Title In French', 'required');
		$this->form_validation->set_rules('title_english', 'Nav Title In English', 'required');

		$this->form_validation->set_rules('show_in_nav', 'Want To Show', 'trim|required');
		...
		if ($this->form_validation->run() == false) {
			...
			if (empty($PrimaryID)) {
				...
				$appRout = array('slug' => $slug, 'type' => 'leproject', 'controller' => 'leproject/detail/' . $insrtID);
