...
<!-- Mirrored from frontendmatters.org/quicky/ltr/light-skin/chat-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Apr 2021 01:40:20 GMT -->
<head>
    <meta charset="UTF-8">
    <!-- Viewport-->
                        ...
                        <div class="hide-scrollbar h-100" id="chatContactsList">
                                    ...
                                    <ul class="nav flex-nowrap">
                                        ...
                                        <li class="nav-item list-inline-item mr-1">
                                            <a class="nav-link text-muted px-1" href="#" title="Notifications" role="button" data-toggle="modal" data-target="#notificationModal">
                                                ...
                                                <!-- Alternate :: External File link -->
                                                <!-- <img class="injectable hw-20" src="./assets_chat/media/heroicons/outline/bell.svg" alt=""> -->
                                            </a>
                                        </li>
                            ...
                            <ul class="contacts-list" id="chatContactTab" data-chat-list="">
                                ...
                                <li class="contacts-item friends">
                                    <a class="contacts-link" href="chat-1.php">
                                    ...
                                    <a class="contacts-link"  href="javascript:;">
                                        <div class="avatar bg-success text-light">
                                            <span>
                                                ...
                                                <!-- Alternate :: External File link -->
                                                <!-- <img class="injectable" src="./assets_chat/media/heroicons/outline/user-group.svg" alt=""> -->
                                            </span>
                                        </div>
                                        <div class="contacts-content">
                                            <div class="contacts-info">
                                            ...
                                            <div class="contacts-texts">
                                                ...
                                                <div class="d-inline-flex align-items-center ml-1">
                                                    ...
                                                    <!-- Alternate :: External File link -->
                                                    <!-- <img class="injectable hw-16 text-muted" src="./assets_chat/media/heroicons/solid/lock-closed.svg" alt=""> -->
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                                ...
                                <li class="contacts-item friends">
                                    <a class="contacts-link" href="#">
                                        <div class="avatar avatar-busy"><img src="assets_chat/media/avatar/3.png" alt=""></div>
                                        <div class="contacts-content">
                                            <div class="contacts-info">
                                            ...
                                            <div class="contacts-texts">
                                                ...
                                                <!-- Alternate :: External File link -->
                                                <!-- <img class="injectable hw-20 text-muted" src="./assets_chat/media/heroicons/solid/photograph.svg" alt=""> -->
                                    ...
                                    <a class="contacts-link" href="#">
                                        ...
                                        <div class="contacts-content">
                                            ...
                                            <div class="contacts-texts">
                                                ...
                                                <!-- Alternate :: External File link -->
                                                <!-- <img class="injectable hw-20 text-muted" src="./assets_chat/media/heroicons/solid/document-report.svg" alt=""> -->
                                ...
                                <li class="contacts-item friends">
                                    <a class="contacts-link" href="#">
                                        <div class="avatar avatar-online"><img src="assets_chat/media/avatar/6.png" alt=""></div>
                                        <div class="contacts-content">
                                            <div class="contacts-info">
                                            ...
                                            <div class="contacts-texts">
                                                ...
                                                <div class="d-inline-flex align-items-center ml-1">
                                                    ...
                                                    <!-- Alternate :: External File link -->
                                                    <!-- <img class="injectable hw-16 text-muted" src="./assets_chat/media/heroicons/solid/volume-off.svg" alt=""> -->
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                                ...
                                <li class="contacts-item friends">
                                    <a class="contacts-link" href="#">
                                        <div class="avatar avatar-offline"><img src="assets_chat/media/avatar/7.png" alt=""></div>
                                        <div class="contacts-content">
                                            <div class="contacts-info">
                                            ...
                                            <div class="contacts-texts">
                                                ...
                                                <!-- Alternate :: External File link -->
                                                <!-- <img class="injectable hw-16 text-muted" src="./assets_chat/media/heroicons/solid/phone-incoming.svg" alt=""> -->
                                ...
                                <li class="contacts-item archived">
                                    <a class="contacts-link" href="#">
                                        <div class="avatar avatar-away"><img src="assets_chat/media/avatar/8.png" alt=""></div>
                                        <div class="contacts-content">
                                            <div class="contacts-info">
                        ...
                        <div class="container">
                            ...
                            <div class="message-day">
                                ...
                                <div class="message">
                                    ...
                                    <div class="message-options">
                                        <div class="avatar avatar-sm"><img alt="" src="assets_chat/media/avatar/1.png"></div>
                                        ...
                                        <div class="dropdown">
                                            <a class="text-muted" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                ...
                                                <!-- Alternate :: External File link -->
                                                <!-- <img class="injectable hw-18" src="./assets_chat/media/heroicons/outline/dots-horizontal.svg" alt="message options"> -->
                                            </a>
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item d-flex align-items-center" href="#">
                                                    ...
                                                    <!-- Alternate :: External File link -->
                                                    <!-- <img class="injectable hw-18 mr-2" src="./assets_chat/media/heroicons/outline/duplicate.svg" alt="message options"> -->
                                                    <span>Copy</span>
                                                </a>
                                                <a class="dropdown-item d-flex align-items-center" href="#">
                                                    <!-- Default :: Inline SVG -->
                                                    ...
                                                    <!-- Alternate :: External File link -->
                                                    <!-- <img class="injectable hw-18 mr-2" src="./assets_chat/media/heroicons/outline/reply.svg" alt="message replay"> -->
                                                    <span>Replay</span>
                                                </a>
                                                <a class="dropdown-item d-flex align-items-center" href="#">
                                                    <!-- Default :: Inline SVG -->
                                                    ...
                                                    <!-- Alternate :: External File link -->
                                                    <!-- <img class="injectable rotate-y hw-18 mr-2" src="./assets_chat/media/heroicons/outline/reply.svg" alt="message forward"> -->
                                                    <span>Forward</span>
                                                </a>
                                                <a class="dropdown-item d-flex align-items-center" href="#">
                                                    <!-- Default :: Inline SVG -->
                                                    ...
                                                    <!-- Alternate :: External File link -->
                                                    <!-- <img class="injectable hw-18 mr-2" src="./assets_chat/media/heroicons/outline/star.svg" alt="message favourite"> -->
                                                    <span>Favourite</span>
                                                </a>
                                ...
                                <div class="message self">
                                    ...
                                    <div class="message-options">
                                        <div class="avatar avatar-sm"><img alt="" src="assets_chat/media/avatar/6.png"></div>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item d-flex align-items-center" href="#">
                                                    ...
                                                    <!-- Alternate :: External File link -->
                                                    <!-- <img class="injectable hw-18 mr-2" src="./assets_chat/media/heroicons/outline/pencil.svg" alt="message edit"> -->
                                                    <span>Edit</span>
                                                </a>
                                                <a class="dropdown-item d-flex align-items-center" href="#">
                                                    <!-- Default :: Inline SVG -->
                                ...
                                <div class="message">
                                    ...
                                    <div class="message-options">
                                        <div class="avatar avatar-sm"><img alt="" src="assets_chat/media/avatar/7.png"></div>
                                        <span class="message-date">9:12am</span>
                                        <div class="dropdown">
                                            <a class="text-muted" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <!-- Default :: Inline SVG -->
                                ...
                                <div class="message">
                                    ...
                                    <div class="message-options">
                                        <div class="avatar avatar-sm"><img alt="" src="assets_chat/media/avatar/2.png"></div>
                                        <span class="message-date">9:12am</span>
                                        <div class="dropdown">
                                            <a class="text-muted" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <!-- Default :: Inline SVG -->
                                ...
                                <div class="message">
                                    ...
                                    <div class="message-options">
                                        <div class="avatar avatar-sm"><img alt="" src="assets_chat/media/avatar/5.png"></div>
                                        <span class="message-date">9:12am</span>
                                        <div class="dropdown">
                                            <a class="text-muted" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <!-- Default :: Inline SVG -->
                            ...
                            <div class="message-day">
                                ...
                                <div class="message">
                                    ...
                                    <div class="message-options">
                                        <div class="avatar avatar-sm"><img alt="" src="assets_chat/media/avatar/4.png"></div>
                                        <span class="message-date">9:12am</span>
                                        <div class="dropdown">
                                            <a class="text-muted" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <!-- Default :: Inline SVG -->
                                ...
                                <div class="message">
                                    ...
                                    <div class="message-options">
                                        <div class="avatar avatar-sm"><img alt="" src="assets_chat/media/avatar/3.png"></div>
                                        <span class="message-date">9:12am</span>
                                        <div class="dropdown">
                                            <a class="text-muted" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <!-- Default :: Inline SVG -->
                        ...
                        <div class="hide-scrollbar flex-fill">
                            ...
                            <div class="border-bottom text-center p-3">
                                ...
                                <div class="avatar bg-success text-light avatar-xl mx-5 mb-3">
                                    <span>
                                        ...
                                        <!-- <img class="injectable hw-50" src="./assets_chat/media/heroicons/outline/user-group.svg" alt=""> -->
                                    </span>
                                </div>
                            ...
                            <div class="chat-info-group">
                                <a class="chat-info-group-header" data-toggle="collapse" href="#participants-list" role="button" aria-expanded="true" aria-controls="participants-list">
                                    ...
                                    <!-- <img class="injectable text-muted hw-20" src="./assets_chat/media/heroicons/outline/user-group.svg" alt=""> -->
                                  </a>
