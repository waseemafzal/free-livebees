                    ...
                    <div class="login-form signup-form">
                        ...
                        <div class="row">
                            ...
                            <form id="form_user" name="form_user" method="POST" class="log-form">
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12 prowrap" style="display:none">
                                ...
                                <div class="prowrap" style="display:none">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 ">
                                    ...
                                    <div class="check-group flexbox">
                                        ...
                                        <label class="check-box">
                                            ...
                                            <span class="remember-text"><?= lang("terms_conditions") ?></span>
