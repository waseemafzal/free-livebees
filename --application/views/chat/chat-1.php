                        ...
                        <div class="hide-scrollbar h-100" id="chatContactsList">
                            ...
                            <div class="sidebar-header sticky-top p-2 chat-header-conversation py-3">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <h5 class="font-weight-semibold mb-0 "><a class="text-dark" href="<?php echo base_url(); ?>">Free Live Bee</a></h5>
                                    <h5 class="font-weight-semibold mb-0 text-dark">Liste des discussions</h5>
