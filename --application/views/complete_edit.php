...
console.log(lng);
		...
		$('#lat_val').html('Latitude:'+lat);
$('#lon_val').html('| Longitude:'+lng);
$('#lat').val(lat);
$('#lon').val(lng);
		}
                ...
                <div class="input-field col-sm-12">
                  ...
                  <div class="adjouter">
                    ...
                    <div class="file-field input-field">
                      ...
                      <input id="choose_file" name="images[]" class="my_get_image_exif" type="file" accept="image/*,video/mp4" multiple>
...
<div class="row">
   <div class="date_picker col-md-6 col-sm-12">
      <h5 class="title">
         <?= lang('next_observation_label'); ?>
      </h5>
      <p class="under_title">
         <?= lang('next_observation'); ?>
      </p>
<input name="next_observation_date" id="next_observation_date" type="text" placeholder="dd-mm-yyyy"    id="next_observation_date">
...
<div class="row">
   ...
   <input name="alarm_before" type="text" placeholder="dd-mm-yyyy hh:mm" value="" autocomplete="off"   id="alarm_before">
      <div id="date_error"></div>
      <p><?=lang('notification_help_text')?></p>
      <br>
      <br>
   </div>
</div>
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          if (response.status == 200) {
            ...
            let url = "<?php echo base_url() . 'map/index?' ?>" + my_url;
...
$(function() {
        ...
        jQuery('#next_observation_date').datetimepicker({
         format:'d-m-Y',
         timepicker:false,
        ...
        jQuery('#alarm_before').datetimepicker({
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-datetimepicker/2.5.20/jquery.datetimepicker.full.min.js" integrity="sha512-AIOTidJAcHBH2G/oZv9viEGXRqDNmfdPVPYOYKGy3fti0xIplnlgMHUGfuNRzC6FkzIo0iIxgFnr9RikFxK+sw==" crossorigin="anonymous" referrerpolicy="no-referrer">
</script>