...
<div class="row">
     ...
     <input name="next_observation_date" id="next_observation_date" type="text" placeholder="dd-mm-yyyy" 
        value="<?php echo $result->next_observation_date; ?>"   
        id="next_observation_date">
    ...
    <div class="row">
       <div class="date_picker col-md-6 col-sm-12">
          ...
          <input name="alarm_before" type="text" placeholder="dd-mm-yyyy hh:mm" value="<?php echo $result->alarm_before; ?>" autocomplete="off"   id="alarm_before">
          <div id="date_error"></div>
