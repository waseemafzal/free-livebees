      ...
      <form method="POST" enctype="multipart/form-data" class="col s12 " style="margin-left:10px;" id="follow_form">
        ...
        <div class="row">
          ...
          <div class="date_picker col s6 m6">
            ...
            <p class="under_title"><?= lang('label_observation_period'); ?></p>
            ...
            <input name="date" type="text" value="<?php echo $date;  ?>" id="next_observation_date">
 ...
 <div class="row">
       <div class="date_picker col-md-6 col-sm-12">
          ...
          if(isset($notification_date)){
             $setnotification_date= $notification_date;
          }else{
              $setnotification_date = date("d-m-Y");
          }
          ?>
         
          <input name="notification_date" value="<?=$setnotification_date?>" type="text" placeholder="dd-mm-yyyy hh:mm"  autocomplete="off"   id="notification_date">
...
<script type="text/javascript">
 ...
 $(function() {
        ...
        jQuery('#notification_date').datetimepicker({
